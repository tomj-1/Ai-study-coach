...
class Rag:
    ...
    def retrieve(self, query, embedded_chunks, amount):
        ...
        best_chunks = sorted(
            embedded_chunks, key=lambda chunk: chunk["similarity"], reverse=True
        )[:amount]
    ...
    def rerank(self, query, candidates, amount):
        ...
        ranking = sorted(data["ranking"], key=lambda item: item["score"], reverse=True)
        ...
        for item in ranking[:amount]:
            ...
            if 0 <= index < len(candidates):
                best_chunks.append(candidates[index])
    ...
    def is_duplicate(self, question, existing_questions, threshold):
        ...
        for old_question in existing_questions:
            ...
            similarity = cosine_similarity([question_embedding], [old_embedding])[0][0]
